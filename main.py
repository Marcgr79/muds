...
if __name__ == "__main__":
    ...
    parser.add_argument('--opcion', choices=['etl','estadistica_pais','funcion_normal', 'frecuencias'], help='Elige la funcion a ejecutar')
    ...
    #Representación grafica de la funcion normal para las edades de todos los archivos
    elif args.opcion == 'funcion_normal':
        distribucion_normal()
